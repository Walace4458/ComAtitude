  ...
  return (
    <SafeAreaView style={styles.area}> 
      <View style={styles.Video}>
          <Feather name="alert-circle" size={32} style={styles.Icon}/>
          <Text style={styles.Titulo}>Exercícios</Text>
          <Text style={styles.Subtitulo}>
              Responda perguntas e melhore seu conhecimento
          </Text>
          <TouchableOpacity 
              style={styles.Buttonn} 
              onPress={() => navigation.navigate('Exercise')}  // 👈 Funcionará agora
          >
...
const styles = StyleSheet.create({
    ...
    Buttonn: { borderWidth: 2, borderRadius: 10, width: 45, padding: 5, backgroundColor: 'rgb(197, 197, 197)', left: 55 }
});
